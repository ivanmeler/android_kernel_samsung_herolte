...
#include "mdnie.h"
#if defined(CONFIG_PANEL_S6E3HF2_WQXGA) || defined(CONFIG_PANEL_S6E36W0X10)
#include "mdnie_lite_table_u.h"
#endif
#endif
...
static int dsim_panel_probe(struct dsim_device *dsim)
{
	...
	dsim->lcd = lcd_device_register(dev_name[dsim->id], dsim->dev, &dsim->priv, NULL);
	if (IS_ERR(dsim->lcd)) {
