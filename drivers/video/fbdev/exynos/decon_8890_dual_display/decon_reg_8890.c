...
//	reg |= DSC_PPS30_31_SLICE_BPG_OFFSET(0x0263);	// WQHD
//	reg |= DSC_PPS30_31_SLICE_BPG_OFFSET(0x032E);	// FHD
...
const signed long decon_clocks_table[][CLK_ID_MAX] = {
	...
	{    71,   168,   400,    66,        71, 1440 * 2560,  MIC_COMP_RATIO_1_2,         0},
	...
	{    4,   168,   400,    66,        63, 1440 * 2560,     MIC_COMP_BYPASS,         2},
};
...
void decon_reg_get_clock_ratio(struct decon_clocks *clks, struct decon_lcd *lcd_info)
{
	...
	if (lcd_info->xres * lcd_info->yres == 1600 * 2560) {
		clks->decon[CLK_ID_VCLK] = decon_clocks_table[3][CLK_ID_VCLK];
		clks->decon[CLK_ID_ECLK] = decon_clocks_table[3][CLK_ID_ECLK];
		clks->decon[CLK_ID_ACLK] = decon_clocks_table[3][CLK_ID_ACLK];
		clks->decon[CLK_ID_PCLK] = decon_clocks_table[3][CLK_ID_PCLK];
		clks->decon[CLK_ID_DPLL] = decon_clocks_table[3][CLK_ID_DPLL];
	} else {
		clks->decon[CLK_ID_VCLK] = decon_clocks_table[7][CLK_ID_VCLK];
		clks->decon[CLK_ID_ECLK] = decon_clocks_table[7][CLK_ID_ECLK];
		clks->decon[CLK_ID_ACLK] = decon_clocks_table[7][CLK_ID_ACLK];
		clks->decon[CLK_ID_PCLK] = decon_clocks_table[7][CLK_ID_PCLK];
		clks->decon[CLK_ID_DPLL] = decon_clocks_table[7][CLK_ID_DPLL];
	}
	return;
...
#else
	clks->decon[CLK_ID_VCLK] = decon_clocks_table[6][CLK_ID_VCLK];
	clks->decon[CLK_ID_ECLK] = decon_clocks_table[6][CLK_ID_ECLK];
	clks->decon[CLK_ID_ACLK] = decon_clocks_table[6][CLK_ID_ACLK];
	clks->decon[CLK_ID_PCLK] = decon_clocks_table[6][CLK_ID_PCLK];
	clks->decon[CLK_ID_DPLL] = decon_clocks_table[6][CLK_ID_DPLL];
	return;
#endif
