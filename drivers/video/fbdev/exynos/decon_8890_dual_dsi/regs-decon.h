...
#define DSC_PPS08_09_PICTURE_WIDHT_MASK			(0xFFFF << 16)
#define DSC_PPS08_09_PICTURE_WIDHT(_v)			((_v) << 16)
...
#define DSC_PPS18_19_INIT_DEC_DELAY_MASK		(0xFFFF << 0)
#define DSC_PPS18_19_INIT_DEC_DELAY(_v)			((_v) << 0)
