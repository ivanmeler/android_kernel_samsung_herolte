...
#define DSC_COMP_ALIGN	(6)			/* 48bit align */
#define MIC_COMP_1_3_ALIGN  (24)	/* 192bit align */
...
enum decon_frame_fifo_mode {
	DECON_FRAME_FIFO_SINGLE = 0,
	DECON_FRAME_FIFO_DUAL = 1,
};
