...
int sensor_module_4h5_probe(struct platform_device *pdev)
{
	int ret = 0;
...
static int sensor_module_4h5_remove(struct platform_device *pdev)
{
        int ret = 0;
...
static struct platform_driver sensor_module_4h5_driver = {
	.probe  = sensor_module_4h5_probe,
	.remove = sensor_module_4h5_remove,
	.driver = {
...
module_platform_driver(sensor_module_4h5_driver);
