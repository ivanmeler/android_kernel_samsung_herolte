...
/*{ SRUK-MALI_SYSTRACE_SUPPORT*/
    ...
    katom->start_timestamp_for_systrace_key = ktime_to_ns(katom->start_timestamp);
    kbase_systrace_mali_job_slots_event(SYSTRACE_EVENT_TYPE_START, js, kctx, kbase_jd_atom_id(kctx, katom), katom->start_timestamp_for_systrace_key,
                                        ...
                                        katom->gles_ctx_handle, katom->frame_number, katom->surfacep);
#endif
/* SRUK-MALI_SYSTRACE_SUPPORT }*/
...
/*{ SRUK-MALI_SYSTRACE_SUPPORT*/
#ifdef CONFIG_MALI_SYSTRACE_SUPPORT
                    kbase_systrace_mali_job_slots_event(SYSTRACE_EVENT_TYPE_STOP, i, NULL, 0, 0, 0, 0, 0, 0, 0, 0, 0);
