...
/*{ SRUK-MALI_SYSTRACE_SUPPORT*/
    ...
    */
    ...
    katom->frame_number = user_atom->frame_number;
    katom->surfacep = user_atom->surfacep;
/*    printk("[SRUK] %s katom->gles_ctx_handle(%x) user_atom->gles_ctx_handle(%x) katom->frame_number(%u) user_atom->frame_number(%u)\n ",
            __func__,katom->gles_ctx_handle, user_atom->gles_ctx_handle, katom->frame_number,user_atom->frame_number); */
